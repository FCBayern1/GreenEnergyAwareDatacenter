...
import cloud.*;
import cloud.datacenter.PowerDatacenterLearningAndInit;
import cloud.policy.VmAllocationAssignerLearningAndInit;
...
import static cloud.policy.VmAllocationAssignerLearningAndInit.QList;
...
public class LearningAndInitScheduleTest {
    ...
    public List<Double> execute() throws Exception {
        ...
        for (String s : QList.keySet()) {
            System.out.println("QList key "+s + ": " + QList.get(s));
        }
